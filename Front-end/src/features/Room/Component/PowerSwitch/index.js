        ...
        <div className="col-12 col-md-6">
            <div className="d-flex flex-column my-5 p-2 border-1 bg-white shadow-sm rounded-xl">
                <div className="d-flex m-3">
                    <div className="Camera_Name me-1">Công tắc nguồn điện</div>
                </div>
                <div className="row">
                    {devicesList.map((item, index) => (
                        <div className="PowerSwitch col-12 col-sm-6 col-md-12 col-lg-6" key={index}>
                            <div
                            ...
                            >
                                <div className="d-flex flex-column p-5">
                                    <div
                                        className="PowerSwitch_Name"
                                        style={{ color: item.control.status && "#fff" }}
                                    >
                                        {item.deviceName}
                                    </div>
                                    <div className="PowerSwitch_Type"
